...
const ROUTE_WAYPOINTS = {
  'Oshodi-Ikeja': [
    { lat: 6.5568, lng: 3.3486, name: 'Oshodi Terminal'  },
    { lat: 6.5612, lng: 3.3498, name: 'Oshodi Market'    },
    { lat: 6.5680, lng: 3.3510, name: 'Airport Rd Jct'   },
    { lat: 6.5720, lng: 3.3515, name: 'Motorway Jct'     },
    { lat: 6.5780, lng: 3.3520, name: 'Allen Avenue'     },
    { lat: 6.6018, lng: 3.3515, name: 'Ikeja Bus Stop'   },
  ],
  'Ikeja-CMS': [
    { lat: 6.6018, lng: 3.3515, name: 'Ikeja Terminal'   },
    { lat: 6.5800, lng: 3.3600, name: 'Ojota Junction'   },
    { lat: 6.5500, lng: 3.3700, name: 'Yaba Overpass'    },
    { lat: 6.5200, lng: 3.3800, name: 'Ebute Metta'      },
    { lat: 6.4900, lng: 3.3900, name: 'Race Course'      },
    { lat: 6.4541, lng: 3.3947, name: 'CMS Terminal'     },
  ],
  'CMS-Lekki': [
    { lat: 6.4541, lng: 3.3947, name: 'CMS Terminal'     },
    { lat: 6.4550, lng: 3.4200, name: 'Victoria Island'  },
    { lat: 6.4600, lng: 3.4600, name: 'Oniru Estate'     },
    { lat: 6.4650, lng: 3.5000, name: 'Lekki Phase 1'   },
    { lat: 6.4698, lng: 3.5852, name: 'Lekki Terminal'   },
  ],
  'Lekki-Ajah': [
    { lat: 6.4698, lng: 3.5852, name: 'Lekki Terminal'   },
    { lat: 6.4680, lng: 3.6100, name: 'Chevron Drive'    },
    { lat: 6.4670, lng: 3.6400, name: 'VGC Gate'         },
    { lat: 6.4660, lng: 3.6700, name: 'Agungi'           },
    { lat: 6.4650, lng: 3.7000, name: 'Ajah Bus Stop'    },
  ],
  'Ikorodu-Owutu': [
    { lat: 6.6194, lng: 3.5060, name: 'Ikorodu Terminal' },
    { lat: 6.6100, lng: 3.5100, name: 'Odogunyan'        },
    { lat: 6.6000, lng: 3.5150, name: 'Agric Junction'   },
    { lat: 6.5900, lng: 3.5200, name: 'Isawo'            },
    { lat: 6.5800, lng: 3.5250, name: 'Owutu Terminal'   },
  ],
};
