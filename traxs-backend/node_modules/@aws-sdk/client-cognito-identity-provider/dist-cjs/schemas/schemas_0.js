...
exports.OperationNotEnabledException$ = [-3, n0, _ONEE,
    { [_e]: _c, [_hE]: 400 },
    [_m],
    [0]
];
n0_registry.registerError(exports.OperationNotEnabledException$, errors_1.OperationNotEnabledException);
...
exports.CreateUserPoolDomainRequest$ = [3, n0, _CUPDR,
    ...
    [0, 0, 1, () => exports.CustomDomainConfigType$, () => exports.RoutingType$], 2
];
exports.CreateUserPoolDomainResponse$ = [3, n0, _CUPDRr,
    0,
    [_MLV, _CFD, _R],
    [1, 0, () => exports.RoutingType$]
];
exports.CreateUserPoolReplicaRequest$ = [3, n0, _CUPRR,
    0,
    [_UPI, _RN, _UPT],
    [0, 0, 128 | 0], 2
];
exports.CreateUserPoolReplicaResponse$ = [3, n0, _CUPRRr,
    0,
    [_UPR],
    [() => exports.UserPoolReplicaType$]
];
...
exports.DeleteUserPoolReplicaRequest$ = [3, n0, _DUPRR,
    0,
    [_UPI, _RN],
    [0, 0], 2
];
exports.DeleteUserPoolReplicaResponse$ = [3, n0, _DUPRRe,
    0,
    [_UPR],
    [() => exports.UserPoolReplicaType$]
];
...
exports.DomainDescriptionType$ = [3, n0, _DDT,
    ...
    [0, 0, 0, 0, 0, 0, 0, () => exports.CustomDomainConfigType$, 1, () => exports.RoutingType$]
];
...
exports.IssuerConfigurationType$ = [3, n0, _ICT,
    0,
    [_Ty],
    [0]
];
exports.KeyConfigurationType$ = [3, n0, _KCT,
    0,
    [_KT, _KKA],
    [0, 0]
];
...
exports.ListUserPoolReplicasRequest$ = [3, n0, _LUPRR,
    0,
    [_UPI, _NT],
    [0, 0], 1
];
exports.ListUserPoolReplicasResponse$ = [3, n0, _LUPRRi,
    0,
    [_UPRs, _NT],
...
exports.UpdateUserPoolReplicaRequest$ = [3, n0, _UUPRR,
    0,
    [_UPI, _RN, _St],
    [0, 0, 0], 3
];
exports.UpdateUserPoolReplicaResponse$ = [3, n0, _UUPRRp,
    0,
    [_UPR],
    [() => exports.UserPoolReplicaType$]
];
...
exports.UserPoolDescriptionType$ = [3, n0, _UPDT,
    ...
    [0, 0, () => exports.LambdaConfigType$, 0, 4, 4, 64 | 0]
];
...
exports.UserPoolReplicaType$ = [3, n0, _UPRT,
    0,
    [_RN, _St, _Ro, _UPA],
    [0, 0, 0, 0]
];
...
exports.CreateUserPoolReplica$ = [9, n0, _CUPRre,
    0, () => exports.CreateUserPoolReplicaRequest$, () => exports.CreateUserPoolReplicaResponse$
];
...
exports.DeleteUserPoolReplica$ = [9, n0, _DUPRel,
    0, () => exports.DeleteUserPoolReplicaRequest$, () => exports.DeleteUserPoolReplicaResponse$
];
...
exports.ListUserPoolReplicas$ = [9, n0, _LUPRis,
    0, () => exports.ListUserPoolReplicasRequest$, () => exports.ListUserPoolReplicasResponse$
];
...
exports.UpdateUserPoolReplica$ = [9, n0, _UUPRpd,
    0, () => exports.UpdateUserPoolReplicaRequest$, () => exports.UpdateUserPoolReplicaResponse$
];
