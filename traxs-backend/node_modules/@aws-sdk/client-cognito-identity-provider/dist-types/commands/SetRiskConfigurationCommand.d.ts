...
import type { SetRiskConfigurationRequest, SetRiskConfigurationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const SetRiskConfigurationCommand_base: {
    new (input: SetRiskConfigurationCommandInput): import("@smithy/core/client").CommandImpl<SetRiskConfigurationCommandInput, SetRiskConfigurationCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SetRiskConfigurationCommandInput): import("@smithy/core/client").CommandImpl<SetRiskConfigurationCommandInput, SetRiskConfigurationCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
