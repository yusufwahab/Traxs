...
import type { CreateUserPoolClientRequest, CreateUserPoolClientResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateUserPoolClientCommand_base: {
    new (input: CreateUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolClientCommandInput, CreateUserPoolClientCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolClientCommandInput, CreateUserPoolClientCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
