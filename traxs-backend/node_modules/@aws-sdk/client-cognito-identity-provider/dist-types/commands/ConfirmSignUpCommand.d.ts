...
import type { ConfirmSignUpRequest, ConfirmSignUpResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ConfirmSignUpCommand_base: {
    new (input: ConfirmSignUpCommandInput): import("@smithy/core/client").CommandImpl<ConfirmSignUpCommandInput, ConfirmSignUpCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ConfirmSignUpCommandInput): import("@smithy/core/client").CommandImpl<ConfirmSignUpCommandInput, ConfirmSignUpCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
