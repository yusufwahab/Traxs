...
import type { DescribeIdentityProviderRequest, DescribeIdentityProviderResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeIdentityProviderCommand_base: {
    new (input: DescribeIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdentityProviderCommandInput, DescribeIdentityProviderCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeIdentityProviderCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdentityProviderCommandInput, DescribeIdentityProviderCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
