...
import type { GetUICustomizationRequest, GetUICustomizationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetUICustomizationCommand_base: {
    new (input: GetUICustomizationCommandInput): import("@smithy/core/client").CommandImpl<GetUICustomizationCommandInput, GetUICustomizationCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetUICustomizationCommandInput): import("@smithy/core/client").CommandImpl<GetUICustomizationCommandInput, GetUICustomizationCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
