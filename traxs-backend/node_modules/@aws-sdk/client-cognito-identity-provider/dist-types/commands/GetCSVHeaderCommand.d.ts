...
import type { GetCSVHeaderRequest, GetCSVHeaderResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetCSVHeaderCommand_base: {
    new (input: GetCSVHeaderCommandInput): import("@smithy/core/client").CommandImpl<GetCSVHeaderCommandInput, GetCSVHeaderCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetCSVHeaderCommandInput): import("@smithy/core/client").CommandImpl<GetCSVHeaderCommandInput, GetCSVHeaderCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
