...
import type { ListUserImportJobsRequest, ListUserImportJobsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListUserImportJobsCommand_base: {
    new (input: ListUserImportJobsCommandInput): import("@smithy/core/client").CommandImpl<ListUserImportJobsCommandInput, ListUserImportJobsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListUserImportJobsCommandInput): import("@smithy/core/client").CommandImpl<ListUserImportJobsCommandInput, ListUserImportJobsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
