...
import type { GetIdentityProviderByIdentifierRequest, GetIdentityProviderByIdentifierResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetIdentityProviderByIdentifierCommand_base: {
    new (input: GetIdentityProviderByIdentifierCommandInput): import("@smithy/core/client").CommandImpl<GetIdentityProviderByIdentifierCommandInput, GetIdentityProviderByIdentifierCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIdentityProviderByIdentifierCommandInput): import("@smithy/core/client").CommandImpl<GetIdentityProviderByIdentifierCommandInput, GetIdentityProviderByIdentifierCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
