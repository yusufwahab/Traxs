...
import type { DeleteUserAttributesRequest, DeleteUserAttributesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteUserAttributesCommand_base: {
    new (input: DeleteUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserAttributesCommandInput, DeleteUserAttributesCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteUserAttributesCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserAttributesCommandInput, DeleteUserAttributesCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
