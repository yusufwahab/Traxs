...
declare const ListUserPoolReplicasCommand_base: {
    new (input: ListUserPoolReplicasCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolReplicasCommandInput, ListUserPoolReplicasCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListUserPoolReplicasCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolReplicasCommandInput, ListUserPoolReplicasCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListUserPoolReplicasCommand extends ListUserPoolReplicasCommand_base {
