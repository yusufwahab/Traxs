...
import type { DeleteUserPoolDomainRequest, DeleteUserPoolDomainResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteUserPoolDomainCommand_base: {
    new (input: DeleteUserPoolDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolDomainCommandInput, DeleteUserPoolDomainCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteUserPoolDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolDomainCommandInput, DeleteUserPoolDomainCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
