...
declare const ListUserPoolClientSecretsCommand_base: {
    new (input: ListUserPoolClientSecretsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolClientSecretsCommandInput, ListUserPoolClientSecretsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListUserPoolClientSecretsCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoolClientSecretsCommandInput, ListUserPoolClientSecretsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
