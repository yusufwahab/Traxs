...
declare const CreateUserPoolReplicaCommand_base: {
    new (input: CreateUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolReplicaCommandInput, CreateUserPoolReplicaCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<CreateUserPoolReplicaCommandInput, CreateUserPoolReplicaCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateUserPoolReplicaCommand extends CreateUserPoolReplicaCommand_base {
