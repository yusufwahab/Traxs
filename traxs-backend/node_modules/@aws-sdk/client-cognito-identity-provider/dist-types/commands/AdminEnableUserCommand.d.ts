...
import type { AdminEnableUserRequest, AdminEnableUserResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const AdminEnableUserCommand_base: {
    new (input: AdminEnableUserCommandInput): import("@smithy/core/client").CommandImpl<AdminEnableUserCommandInput, AdminEnableUserCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: AdminEnableUserCommandInput): import("@smithy/core/client").CommandImpl<AdminEnableUserCommandInput, AdminEnableUserCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
