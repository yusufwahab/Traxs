...
import type { ForgetDeviceRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const ForgetDeviceCommand_base: {
    new (input: ForgetDeviceCommandInput): import("@smithy/core/client").CommandImpl<ForgetDeviceCommandInput, ForgetDeviceCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ForgetDeviceCommandInput): import("@smithy/core/client").CommandImpl<ForgetDeviceCommandInput, ForgetDeviceCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
