...
import type { ListTermsRequest, ListTermsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListTermsCommand_base: {
    new (input: ListTermsCommandInput): import("@smithy/core/client").CommandImpl<ListTermsCommandInput, ListTermsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListTermsCommandInput): import("@smithy/core/client").CommandImpl<ListTermsCommandInput, ListTermsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
