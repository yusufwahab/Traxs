...
import type { DescribeTermsRequest, DescribeTermsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeTermsCommand_base: {
    new (input: DescribeTermsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTermsCommandInput, DescribeTermsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeTermsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTermsCommandInput, DescribeTermsCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
