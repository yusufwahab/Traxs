...
import type { DescribeUserPoolRequest, DescribeUserPoolResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeUserPoolCommand_base: {
    new (input: DescribeUserPoolCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserPoolCommandInput, DescribeUserPoolCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeUserPoolCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserPoolCommandInput, DescribeUserPoolCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
