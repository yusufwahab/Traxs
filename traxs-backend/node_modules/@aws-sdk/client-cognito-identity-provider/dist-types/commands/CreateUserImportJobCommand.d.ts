...
import type { CreateUserImportJobRequest, CreateUserImportJobResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateUserImportJobCommand_base: {
    new (input: CreateUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<CreateUserImportJobCommandInput, CreateUserImportJobCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<CreateUserImportJobCommandInput, CreateUserImportJobCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
