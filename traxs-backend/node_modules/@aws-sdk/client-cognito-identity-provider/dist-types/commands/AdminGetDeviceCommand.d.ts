...
import type { AdminGetDeviceRequest, AdminGetDeviceResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const AdminGetDeviceCommand_base: {
    new (input: AdminGetDeviceCommandInput): import("@smithy/core/client").CommandImpl<AdminGetDeviceCommandInput, AdminGetDeviceCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: AdminGetDeviceCommandInput): import("@smithy/core/client").CommandImpl<AdminGetDeviceCommandInput, AdminGetDeviceCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
