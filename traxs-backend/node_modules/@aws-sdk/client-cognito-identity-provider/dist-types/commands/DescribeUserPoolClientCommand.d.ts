...
import type { DescribeUserPoolClientRequest, DescribeUserPoolClientResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeUserPoolClientCommand_base: {
    new (input: DescribeUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserPoolClientCommandInput, DescribeUserPoolClientCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeUserPoolClientCommandInput): import("@smithy/core/client").CommandImpl<DescribeUserPoolClientCommandInput, DescribeUserPoolClientCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
