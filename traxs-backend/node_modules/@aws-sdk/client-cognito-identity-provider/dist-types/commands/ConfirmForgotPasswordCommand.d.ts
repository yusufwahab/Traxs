...
import type { ConfirmForgotPasswordRequest, ConfirmForgotPasswordResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ConfirmForgotPasswordCommand_base: {
    new (input: ConfirmForgotPasswordCommandInput): import("@smithy/core/client").CommandImpl<ConfirmForgotPasswordCommandInput, ConfirmForgotPasswordCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ConfirmForgotPasswordCommandInput): import("@smithy/core/client").CommandImpl<ConfirmForgotPasswordCommandInput, ConfirmForgotPasswordCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
