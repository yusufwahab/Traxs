...
import type { CreateManagedLoginBrandingRequest, CreateManagedLoginBrandingResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateManagedLoginBrandingCommand_base: {
    new (input: CreateManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<CreateManagedLoginBrandingCommandInput, CreateManagedLoginBrandingCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateManagedLoginBrandingCommandInput): import("@smithy/core/client").CommandImpl<CreateManagedLoginBrandingCommandInput, CreateManagedLoginBrandingCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
