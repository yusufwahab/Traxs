...
declare const DeleteUserPoolReplicaCommand_base: {
    new (input: DeleteUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolReplicaCommandInput, DeleteUserPoolReplicaCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteUserPoolReplicaCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPoolReplicaCommandInput, DeleteUserPoolReplicaCommandOutput, CognitoIdentityProviderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteUserPoolReplicaCommand extends DeleteUserPoolReplicaCommand_base {
