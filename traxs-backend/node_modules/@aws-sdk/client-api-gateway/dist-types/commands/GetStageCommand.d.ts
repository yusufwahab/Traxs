...
import type { GetStageRequest, Stage } from "../models/models_0";
/**
 * @public
 */
...
declare const GetStageCommand_base: {
    new (input: GetStageCommandInput): import("@smithy/core/client").CommandImpl<GetStageCommandInput, GetStageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetStageCommandInput): import("@smithy/core/client").CommandImpl<GetStageCommandInput, GetStageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
