...
import type { DocumentationVersion, GetDocumentationVersionRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDocumentationVersionCommand_base: {
    new (input: GetDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionCommandInput, GetDocumentationVersionCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionCommandInput, GetDocumentationVersionCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
