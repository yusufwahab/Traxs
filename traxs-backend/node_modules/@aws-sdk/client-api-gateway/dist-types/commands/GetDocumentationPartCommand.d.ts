...
import type { DocumentationPart, GetDocumentationPartRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDocumentationPartCommand_base: {
    new (input: GetDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationPartCommandInput, GetDocumentationPartCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationPartCommandInput, GetDocumentationPartCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
