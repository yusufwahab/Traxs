...
import type { DomainNames, GetDomainNamesRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDomainNamesCommand_base: {
    new (input: GetDomainNamesCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNamesCommandInput, GetDomainNamesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetDomainNamesCommandInput]): import("@smithy/core/client").CommandImpl<GetDomainNamesCommandInput, GetDomainNamesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
