...
import type { GatewayResponse, UpdateGatewayResponseRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateGatewayResponseCommand_base: {
    new (input: UpdateGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayResponseCommandInput, UpdateGatewayResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateGatewayResponseCommandInput, UpdateGatewayResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
