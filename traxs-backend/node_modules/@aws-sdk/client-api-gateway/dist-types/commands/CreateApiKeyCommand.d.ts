...
import type { ApiKey, CreateApiKeyRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateApiKeyCommand_base: {
    new (input: CreateApiKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateApiKeyCommandInput, CreateApiKeyCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [CreateApiKeyCommandInput]): import("@smithy/core/client").CommandImpl<CreateApiKeyCommandInput, CreateApiKeyCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
