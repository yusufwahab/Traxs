...
import type { DocumentationVersions, GetDocumentationVersionsRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetDocumentationVersionsCommand_base: {
    new (input: GetDocumentationVersionsCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionsCommandInput, GetDocumentationVersionsCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetDocumentationVersionsCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionsCommandInput, GetDocumentationVersionsCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
