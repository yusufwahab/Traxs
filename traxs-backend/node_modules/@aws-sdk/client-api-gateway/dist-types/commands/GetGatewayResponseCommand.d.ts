...
import type { GatewayResponse, GetGatewayResponseRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetGatewayResponseCommand_base: {
    new (input: GetGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayResponseCommandInput, GetGatewayResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayResponseCommandInput, GetGatewayResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
