...
import type { DeleteRestApiRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteRestApiCommand_base: {
    new (input: DeleteRestApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteRestApiCommandInput, DeleteRestApiCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteRestApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteRestApiCommandInput, DeleteRestApiCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
