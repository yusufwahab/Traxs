...
import type { RequestValidator, UpdateRequestValidatorRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateRequestValidatorCommand_base: {
    new (input: UpdateRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateRequestValidatorCommandInput, UpdateRequestValidatorCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateRequestValidatorCommandInput, UpdateRequestValidatorCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
