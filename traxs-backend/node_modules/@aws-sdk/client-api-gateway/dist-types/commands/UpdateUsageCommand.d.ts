...
import type { UpdateUsageRequest, Usage } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateUsageCommand_base: {
    new (input: UpdateUsageCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsageCommandInput, UpdateUsageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateUsageCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsageCommandInput, UpdateUsageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
