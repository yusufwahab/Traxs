...
import type { GetRequestValidatorRequest, RequestValidator } from "../models/models_0";
/**
 * @public
 */
...
declare const GetRequestValidatorCommand_base: {
    new (input: GetRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<GetRequestValidatorCommandInput, GetRequestValidatorCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<GetRequestValidatorCommandInput, GetRequestValidatorCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
