...
import type { CreateVpcLinkRequest, VpcLink } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateVpcLinkCommand_base: {
    new (input: CreateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcLinkCommandInput, CreateVpcLinkCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcLinkCommandInput, CreateVpcLinkCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
