...
import type { CreateDocumentationVersionRequest, DocumentationVersion } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateDocumentationVersionCommand_base: {
    new (input: CreateDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationVersionCommandInput, CreateDocumentationVersionCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationVersionCommandInput, CreateDocumentationVersionCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
