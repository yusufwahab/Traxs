...
import type { DeleteGatewayResponseRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteGatewayResponseCommand_base: {
    new (input: DeleteGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayResponseCommandInput, DeleteGatewayResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayResponseCommandInput, DeleteGatewayResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
