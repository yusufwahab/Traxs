...
import type { GetMethodRequest, Method } from "../models/models_0";
/**
 * @public
 */
...
declare const GetMethodCommand_base: {
    new (input: GetMethodCommandInput): import("@smithy/core/client").CommandImpl<GetMethodCommandInput, GetMethodCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetMethodCommandInput): import("@smithy/core/client").CommandImpl<GetMethodCommandInput, GetMethodCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
