...
import type { ClientCertificate, UpdateClientCertificateRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateClientCertificateCommand_base: {
    new (input: UpdateClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateClientCertificateCommandInput, UpdateClientCertificateCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateClientCertificateCommandInput, UpdateClientCertificateCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
