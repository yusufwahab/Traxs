...
import type { CreateDocumentationPartRequest, DocumentationPart } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateDocumentationPartCommand_base: {
    new (input: CreateDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationPartCommandInput, CreateDocumentationPartCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationPartCommandInput, CreateDocumentationPartCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
