...
import type { IntegrationResponse, UpdateIntegrationResponseRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateIntegrationResponseCommand_base: {
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
