...
import type { GetIntegrationResponseRequest, IntegrationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetIntegrationResponseCommand_base: {
    new (input: GetIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationResponseCommandInput, GetIntegrationResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationResponseCommandInput, GetIntegrationResponseCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
