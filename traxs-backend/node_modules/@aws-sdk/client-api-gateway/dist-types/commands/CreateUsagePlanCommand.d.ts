...
import type { CreateUsagePlanRequest, UsagePlan } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateUsagePlanCommand_base: {
    new (input: CreateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<CreateUsagePlanCommandInput, CreateUsagePlanCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<CreateUsagePlanCommandInput, CreateUsagePlanCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
