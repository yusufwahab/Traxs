...
import type { GetIntegrationRequest, Integration } from "../models/models_0";
/**
 * @public
 */
...
declare const GetIntegrationCommand_base: {
    new (input: GetIntegrationCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIntegrationCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
