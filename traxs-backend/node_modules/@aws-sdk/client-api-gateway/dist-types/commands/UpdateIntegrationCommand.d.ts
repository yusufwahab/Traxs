...
import type { Integration, UpdateIntegrationRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateIntegrationCommand_base: {
    new (input: UpdateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationCommandInput, UpdateIntegrationCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationCommandInput, UpdateIntegrationCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
