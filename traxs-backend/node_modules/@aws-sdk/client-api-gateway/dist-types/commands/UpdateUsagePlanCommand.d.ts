...
import type { UpdateUsagePlanRequest, UsagePlan } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateUsagePlanCommand_base: {
    new (input: UpdateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsagePlanCommandInput, UpdateUsagePlanCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsagePlanCommandInput, UpdateUsagePlanCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
