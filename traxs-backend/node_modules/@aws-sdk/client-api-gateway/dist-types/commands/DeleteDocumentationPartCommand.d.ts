...
import type { DeleteDocumentationPartRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteDocumentationPartCommand_base: {
    new (input: DeleteDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentationPartCommandInput, DeleteDocumentationPartCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentationPartCommandInput, DeleteDocumentationPartCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
