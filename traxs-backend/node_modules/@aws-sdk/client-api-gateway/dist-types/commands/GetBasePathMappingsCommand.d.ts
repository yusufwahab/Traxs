...
import type { BasePathMappings, GetBasePathMappingsRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetBasePathMappingsCommand_base: {
    new (input: GetBasePathMappingsCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingsCommandInput, GetBasePathMappingsCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetBasePathMappingsCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingsCommandInput, GetBasePathMappingsCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
