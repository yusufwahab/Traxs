...
import type { GetRestApiRequest, RestApi } from "../models/models_0";
/**
 * @public
 */
...
declare const GetRestApiCommand_base: {
    new (input: GetRestApiCommandInput): import("@smithy/core/client").CommandImpl<GetRestApiCommandInput, GetRestApiCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetRestApiCommandInput): import("@smithy/core/client").CommandImpl<GetRestApiCommandInput, GetRestApiCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
