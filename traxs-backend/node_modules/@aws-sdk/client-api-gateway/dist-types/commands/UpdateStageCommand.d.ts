...
import type { Stage, UpdateStageRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateStageCommand_base: {
    new (input: UpdateStageCommandInput): import("@smithy/core/client").CommandImpl<UpdateStageCommandInput, UpdateStageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateStageCommandInput): import("@smithy/core/client").CommandImpl<UpdateStageCommandInput, UpdateStageCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
