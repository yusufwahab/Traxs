...
import type { FlushStageAuthorizersCacheRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const FlushStageAuthorizersCacheCommand_base: {
    new (input: FlushStageAuthorizersCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushStageAuthorizersCacheCommandInput, FlushStageAuthorizersCacheCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: FlushStageAuthorizersCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushStageAuthorizersCacheCommandInput, FlushStageAuthorizersCacheCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
