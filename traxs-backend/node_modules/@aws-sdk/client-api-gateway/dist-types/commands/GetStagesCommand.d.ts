...
import type { GetStagesRequest, Stages } from "../models/models_0";
/**
 * @public
 */
...
declare const GetStagesCommand_base: {
    new (input: GetStagesCommandInput): import("@smithy/core/client").CommandImpl<GetStagesCommandInput, GetStagesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetStagesCommandInput): import("@smithy/core/client").CommandImpl<GetStagesCommandInput, GetStagesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
