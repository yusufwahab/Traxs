...
import type { GetSdkTypesRequest, SdkTypes } from "../models/models_0";
/**
 * @public
 */
...
declare const GetSdkTypesCommand_base: {
    new (input: GetSdkTypesCommandInput): import("@smithy/core/client").CommandImpl<GetSdkTypesCommandInput, GetSdkTypesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetSdkTypesCommandInput]): import("@smithy/core/client").CommandImpl<GetSdkTypesCommandInput, GetSdkTypesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
