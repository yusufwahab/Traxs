...
import type { ClientCertificate, GenerateClientCertificateRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GenerateClientCertificateCommand_base: {
    new (input: GenerateClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<GenerateClientCertificateCommandInput, GenerateClientCertificateCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GenerateClientCertificateCommandInput]): import("@smithy/core/client").CommandImpl<GenerateClientCertificateCommandInput, GenerateClientCertificateCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
