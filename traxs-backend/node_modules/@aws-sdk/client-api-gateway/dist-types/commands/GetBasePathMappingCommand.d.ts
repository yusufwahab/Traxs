...
import type { BasePathMapping, GetBasePathMappingRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetBasePathMappingCommand_base: {
    new (input: GetBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingCommandInput, GetBasePathMappingCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingCommandInput, GetBasePathMappingCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
