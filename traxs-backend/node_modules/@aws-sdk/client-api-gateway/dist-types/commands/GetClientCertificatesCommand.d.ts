...
import type { ClientCertificates, GetClientCertificatesRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetClientCertificatesCommand_base: {
    new (input: GetClientCertificatesCommandInput): import("@smithy/core/client").CommandImpl<GetClientCertificatesCommandInput, GetClientCertificatesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetClientCertificatesCommandInput]): import("@smithy/core/client").CommandImpl<GetClientCertificatesCommandInput, GetClientCertificatesCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
