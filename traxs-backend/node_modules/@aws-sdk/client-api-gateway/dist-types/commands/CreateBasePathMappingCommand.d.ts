...
import type { BasePathMapping, CreateBasePathMappingRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateBasePathMappingCommand_base: {
    new (input: CreateBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<CreateBasePathMappingCommandInput, CreateBasePathMappingCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<CreateBasePathMappingCommandInput, CreateBasePathMappingCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
