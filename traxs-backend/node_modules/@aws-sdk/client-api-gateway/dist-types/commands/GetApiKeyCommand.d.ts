...
import type { ApiKey, GetApiKeyRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const GetApiKeyCommand_base: {
    new (input: GetApiKeyCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeyCommandInput, GetApiKeyCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetApiKeyCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeyCommandInput, GetApiKeyCommandOutput, APIGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
