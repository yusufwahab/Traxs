...
import type { UpdateStackSetInput, UpdateStackSetOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateStackSetCommand_base: {
    new (input: UpdateStackSetCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackSetCommandInput, UpdateStackSetCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateStackSetCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackSetCommandInput, UpdateStackSetCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
