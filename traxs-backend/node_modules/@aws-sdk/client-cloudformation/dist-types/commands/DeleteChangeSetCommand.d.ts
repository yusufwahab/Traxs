...
import type { DeleteChangeSetInput, DeleteChangeSetOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteChangeSetCommand_base: {
    new (input: DeleteChangeSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteChangeSetCommandInput, DeleteChangeSetCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteChangeSetCommandInput): import("@smithy/core/client").CommandImpl<DeleteChangeSetCommandInput, DeleteChangeSetCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
