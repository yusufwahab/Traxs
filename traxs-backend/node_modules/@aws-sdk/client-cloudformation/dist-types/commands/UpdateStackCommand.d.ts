...
import type { UpdateStackInput, UpdateStackOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateStackCommand_base: {
    new (input: UpdateStackCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackCommandInput, UpdateStackCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateStackCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackCommandInput, UpdateStackCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
