...
import type { GetStackPolicyInput, GetStackPolicyOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetStackPolicyCommand_base: {
    new (input: GetStackPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetStackPolicyCommandInput, GetStackPolicyCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetStackPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetStackPolicyCommandInput, GetStackPolicyCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
