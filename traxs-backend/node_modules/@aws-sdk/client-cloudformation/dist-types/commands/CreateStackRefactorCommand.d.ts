...
import type { CreateStackRefactorInput, CreateStackRefactorOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateStackRefactorCommand_base: {
    new (input: CreateStackRefactorCommandInput): import("@smithy/core/client").CommandImpl<CreateStackRefactorCommandInput, CreateStackRefactorCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateStackRefactorCommandInput): import("@smithy/core/client").CommandImpl<CreateStackRefactorCommandInput, CreateStackRefactorCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
