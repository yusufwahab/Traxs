...
import type { ListStackInstancesInput, ListStackInstancesOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListStackInstancesCommand_base: {
    new (input: ListStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<ListStackInstancesCommandInput, ListStackInstancesCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<ListStackInstancesCommandInput, ListStackInstancesCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
