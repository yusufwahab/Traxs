...
declare const UpdateStackInstancesCommand_base: {
    new (input: UpdateStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackInstancesCommandInput, UpdateStackInstancesCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateStackInstancesCommandInput): import("@smithy/core/client").CommandImpl<UpdateStackInstancesCommandInput, UpdateStackInstancesCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
