...
import type { DeleteGeneratedTemplateInput } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteGeneratedTemplateCommand_base: {
    new (input: DeleteGeneratedTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteGeneratedTemplateCommandInput, DeleteGeneratedTemplateCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteGeneratedTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteGeneratedTemplateCommandInput, DeleteGeneratedTemplateCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
