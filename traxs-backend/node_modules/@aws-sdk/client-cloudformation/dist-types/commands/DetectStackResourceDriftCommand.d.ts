...
declare const DetectStackResourceDriftCommand_base: {
    new (input: DetectStackResourceDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackResourceDriftCommandInput, DetectStackResourceDriftCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DetectStackResourceDriftCommandInput): import("@smithy/core/client").CommandImpl<DetectStackResourceDriftCommandInput, DetectStackResourceDriftCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
