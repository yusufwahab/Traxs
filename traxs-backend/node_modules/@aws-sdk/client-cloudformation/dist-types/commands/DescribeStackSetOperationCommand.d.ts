...
import type { DescribeStackSetOperationInput, DescribeStackSetOperationOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeStackSetOperationCommand_base: {
    new (input: DescribeStackSetOperationCommandInput): import("@smithy/core/client").CommandImpl<DescribeStackSetOperationCommandInput, DescribeStackSetOperationCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeStackSetOperationCommandInput): import("@smithy/core/client").CommandImpl<DescribeStackSetOperationCommandInput, DescribeStackSetOperationCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
