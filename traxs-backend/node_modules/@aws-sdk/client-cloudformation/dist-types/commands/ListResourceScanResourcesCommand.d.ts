...
import type { ListResourceScanResourcesInput, ListResourceScanResourcesOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListResourceScanResourcesCommand_base: {
    new (input: ListResourceScanResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListResourceScanResourcesCommandInput, ListResourceScanResourcesCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListResourceScanResourcesCommandInput): import("@smithy/core/client").CommandImpl<ListResourceScanResourcesCommandInput, ListResourceScanResourcesCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
