...
import type { ImportStacksToStackSetInput, ImportStacksToStackSetOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ImportStacksToStackSetCommand_base: {
    new (input: ImportStacksToStackSetCommandInput): import("@smithy/core/client").CommandImpl<ImportStacksToStackSetCommandInput, ImportStacksToStackSetCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ImportStacksToStackSetCommandInput): import("@smithy/core/client").CommandImpl<ImportStacksToStackSetCommandInput, ImportStacksToStackSetCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
