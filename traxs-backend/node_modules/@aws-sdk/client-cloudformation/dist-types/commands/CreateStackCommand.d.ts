...
import type { CreateStackInput, CreateStackOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateStackCommand_base: {
    new (input: CreateStackCommandInput): import("@smithy/core/client").CommandImpl<CreateStackCommandInput, CreateStackCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateStackCommandInput): import("@smithy/core/client").CommandImpl<CreateStackCommandInput, CreateStackCommandOutput, CloudFormationClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
