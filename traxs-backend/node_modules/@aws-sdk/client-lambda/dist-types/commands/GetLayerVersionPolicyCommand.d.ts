...
import type { GetLayerVersionPolicyRequest, GetLayerVersionPolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetLayerVersionPolicyCommand_base: {
    new (input: GetLayerVersionPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionPolicyCommandInput, GetLayerVersionPolicyCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetLayerVersionPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLayerVersionPolicyCommandInput, GetLayerVersionPolicyCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
