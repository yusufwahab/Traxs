...
import type { GetFunctionConcurrencyRequest, GetFunctionConcurrencyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetFunctionConcurrencyCommand_base: {
    new (input: GetFunctionConcurrencyCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionConcurrencyCommandInput, GetFunctionConcurrencyCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFunctionConcurrencyCommandInput): import("@smithy/core/client").CommandImpl<GetFunctionConcurrencyCommandInput, GetFunctionConcurrencyCommandOutput, LambdaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
