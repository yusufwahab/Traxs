...
import type { ListInstanceProfilesRequest, ListInstanceProfilesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListInstanceProfilesCommand_base: {
    new (input: ListInstanceProfilesCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfilesCommandInput, ListInstanceProfilesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListInstanceProfilesCommandInput]): import("@smithy/core/client").CommandImpl<ListInstanceProfilesCommandInput, ListInstanceProfilesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
