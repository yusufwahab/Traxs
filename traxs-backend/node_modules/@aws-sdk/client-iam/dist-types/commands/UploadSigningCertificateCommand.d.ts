...
import type { UploadSigningCertificateRequest, UploadSigningCertificateResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UploadSigningCertificateCommand_base: {
    new (input: UploadSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<UploadSigningCertificateCommandInput, UploadSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UploadSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<UploadSigningCertificateCommandInput, UploadSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
