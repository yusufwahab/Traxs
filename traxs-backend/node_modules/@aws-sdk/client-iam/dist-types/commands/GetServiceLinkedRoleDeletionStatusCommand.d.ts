...
import type { GetServiceLinkedRoleDeletionStatusRequest, GetServiceLinkedRoleDeletionStatusResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetServiceLinkedRoleDeletionStatusCommand_base: {
    new (input: GetServiceLinkedRoleDeletionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLinkedRoleDeletionStatusCommandInput, GetServiceLinkedRoleDeletionStatusCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetServiceLinkedRoleDeletionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLinkedRoleDeletionStatusCommandInput, GetServiceLinkedRoleDeletionStatusCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
