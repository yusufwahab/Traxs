...
import type { ListAttachedRolePoliciesRequest, ListAttachedRolePoliciesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAttachedRolePoliciesCommand_base: {
    new (input: ListAttachedRolePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedRolePoliciesCommandInput, ListAttachedRolePoliciesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAttachedRolePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedRolePoliciesCommandInput, ListAttachedRolePoliciesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
