...
import type { UpdateGroupRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateGroupCommand_base: {
    new (input: UpdateGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateGroupCommandInput, UpdateGroupCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateGroupCommandInput): import("@smithy/core/client").CommandImpl<UpdateGroupCommandInput, UpdateGroupCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
