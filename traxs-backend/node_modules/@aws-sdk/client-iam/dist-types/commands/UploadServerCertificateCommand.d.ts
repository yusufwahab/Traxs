...
import type { UploadServerCertificateRequest, UploadServerCertificateResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UploadServerCertificateCommand_base: {
    new (input: UploadServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UploadServerCertificateCommandInput, UploadServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UploadServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UploadServerCertificateCommandInput, UploadServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
