...
import type { GetContextKeysForCustomPolicyRequest, GetContextKeysForPolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetContextKeysForCustomPolicyCommand_base: {
    new (input: GetContextKeysForCustomPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContextKeysForCustomPolicyCommandInput, GetContextKeysForCustomPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetContextKeysForCustomPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContextKeysForCustomPolicyCommandInput, GetContextKeysForCustomPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
