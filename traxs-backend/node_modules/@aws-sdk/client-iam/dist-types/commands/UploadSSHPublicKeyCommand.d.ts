...
import type { UploadSSHPublicKeyRequest, UploadSSHPublicKeyResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UploadSSHPublicKeyCommand_base: {
    new (input: UploadSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<UploadSSHPublicKeyCommandInput, UploadSSHPublicKeyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UploadSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<UploadSSHPublicKeyCommandInput, UploadSSHPublicKeyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
