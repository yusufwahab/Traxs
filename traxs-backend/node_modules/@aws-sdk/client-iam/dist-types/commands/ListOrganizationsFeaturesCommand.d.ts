...
import type { ListOrganizationsFeaturesRequest, ListOrganizationsFeaturesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListOrganizationsFeaturesCommand_base: {
    new (input: ListOrganizationsFeaturesCommandInput): import("@smithy/core/client").CommandImpl<ListOrganizationsFeaturesCommandInput, ListOrganizationsFeaturesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListOrganizationsFeaturesCommandInput]): import("@smithy/core/client").CommandImpl<ListOrganizationsFeaturesCommandInput, ListOrganizationsFeaturesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
