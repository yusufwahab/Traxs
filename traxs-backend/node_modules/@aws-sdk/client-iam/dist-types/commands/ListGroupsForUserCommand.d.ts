...
import type { ListGroupsForUserRequest, ListGroupsForUserResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListGroupsForUserCommand_base: {
    new (input: ListGroupsForUserCommandInput): import("@smithy/core/client").CommandImpl<ListGroupsForUserCommandInput, ListGroupsForUserCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListGroupsForUserCommandInput): import("@smithy/core/client").CommandImpl<ListGroupsForUserCommandInput, ListGroupsForUserCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
