...
import type { ListPoliciesGrantingServiceAccessRequest, ListPoliciesGrantingServiceAccessResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListPoliciesGrantingServiceAccessCommand_base: {
    new (input: ListPoliciesGrantingServiceAccessCommandInput): import("@smithy/core/client").CommandImpl<ListPoliciesGrantingServiceAccessCommandInput, ListPoliciesGrantingServiceAccessCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListPoliciesGrantingServiceAccessCommandInput): import("@smithy/core/client").CommandImpl<ListPoliciesGrantingServiceAccessCommandInput, ListPoliciesGrantingServiceAccessCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
