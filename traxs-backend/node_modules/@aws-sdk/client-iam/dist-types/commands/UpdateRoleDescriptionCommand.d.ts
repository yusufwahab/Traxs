...
import type { UpdateRoleDescriptionRequest, UpdateRoleDescriptionResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateRoleDescriptionCommand_base: {
    new (input: UpdateRoleDescriptionCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleDescriptionCommandInput, UpdateRoleDescriptionCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateRoleDescriptionCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleDescriptionCommandInput, UpdateRoleDescriptionCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
