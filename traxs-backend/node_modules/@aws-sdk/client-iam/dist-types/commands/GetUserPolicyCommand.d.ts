...
import type { GetUserPolicyRequest, GetUserPolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetUserPolicyCommand_base: {
    new (input: GetUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetUserPolicyCommandInput, GetUserPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetUserPolicyCommandInput, GetUserPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
