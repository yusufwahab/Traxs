...
import type { ListPolicyTagsRequest, ListPolicyTagsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListPolicyTagsCommand_base: {
    new (input: ListPolicyTagsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyTagsCommandInput, ListPolicyTagsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListPolicyTagsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyTagsCommandInput, ListPolicyTagsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
