...
import type { GetServiceLastAccessedDetailsWithEntitiesRequest, GetServiceLastAccessedDetailsWithEntitiesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetServiceLastAccessedDetailsWithEntitiesCommand_base: {
    new (input: GetServiceLastAccessedDetailsWithEntitiesCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLastAccessedDetailsWithEntitiesCommandInput, GetServiceLastAccessedDetailsWithEntitiesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetServiceLastAccessedDetailsWithEntitiesCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLastAccessedDetailsWithEntitiesCommandInput, GetServiceLastAccessedDetailsWithEntitiesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
