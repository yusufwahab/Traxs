...
import type { UntagRoleRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UntagRoleCommand_base: {
    new (input: UntagRoleCommandInput): import("@smithy/core/client").CommandImpl<UntagRoleCommandInput, UntagRoleCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UntagRoleCommandInput): import("@smithy/core/client").CommandImpl<UntagRoleCommandInput, UntagRoleCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
