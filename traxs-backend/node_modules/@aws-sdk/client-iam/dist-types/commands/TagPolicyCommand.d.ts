...
import type { TagPolicyRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const TagPolicyCommand_base: {
    new (input: TagPolicyCommandInput): import("@smithy/core/client").CommandImpl<TagPolicyCommandInput, TagPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: TagPolicyCommandInput): import("@smithy/core/client").CommandImpl<TagPolicyCommandInput, TagPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
