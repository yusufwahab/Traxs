...
import type { GetSAMLProviderRequest, GetSAMLProviderResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetSAMLProviderCommand_base: {
    new (input: GetSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<GetSAMLProviderCommandInput, GetSAMLProviderCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<GetSAMLProviderCommandInput, GetSAMLProviderCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
