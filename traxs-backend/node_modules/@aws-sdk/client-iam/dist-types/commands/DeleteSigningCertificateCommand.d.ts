...
import type { DeleteSigningCertificateRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteSigningCertificateCommand_base: {
    new (input: DeleteSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteSigningCertificateCommandInput, DeleteSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteSigningCertificateCommandInput, DeleteSigningCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
