...
import type { EnableOrganizationsRootSessionsRequest, EnableOrganizationsRootSessionsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const EnableOrganizationsRootSessionsCommand_base: {
    new (input: EnableOrganizationsRootSessionsCommandInput): import("@smithy/core/client").CommandImpl<EnableOrganizationsRootSessionsCommandInput, EnableOrganizationsRootSessionsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [EnableOrganizationsRootSessionsCommandInput]): import("@smithy/core/client").CommandImpl<EnableOrganizationsRootSessionsCommandInput, EnableOrganizationsRootSessionsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
