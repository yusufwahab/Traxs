...
import type { ListGroupPoliciesRequest, ListGroupPoliciesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListGroupPoliciesCommand_base: {
    new (input: ListGroupPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListGroupPoliciesCommandInput, ListGroupPoliciesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListGroupPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListGroupPoliciesCommandInput, ListGroupPoliciesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
