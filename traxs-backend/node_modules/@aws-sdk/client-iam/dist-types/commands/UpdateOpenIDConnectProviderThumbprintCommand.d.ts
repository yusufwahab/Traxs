...
import type { UpdateOpenIDConnectProviderThumbprintRequest } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateOpenIDConnectProviderThumbprintCommand_base: {
    new (input: UpdateOpenIDConnectProviderThumbprintCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpenIDConnectProviderThumbprintCommandInput, UpdateOpenIDConnectProviderThumbprintCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateOpenIDConnectProviderThumbprintCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpenIDConnectProviderThumbprintCommandInput, UpdateOpenIDConnectProviderThumbprintCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
