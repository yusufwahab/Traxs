...
import type { GetInstanceProfileRequest, GetInstanceProfileResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetInstanceProfileCommand_base: {
    new (input: GetInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceProfileCommandInput, GetInstanceProfileCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceProfileCommandInput, GetInstanceProfileCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
