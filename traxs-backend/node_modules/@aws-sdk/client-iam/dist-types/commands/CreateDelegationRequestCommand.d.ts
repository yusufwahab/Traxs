...
import type { CreateDelegationRequestRequest, CreateDelegationRequestResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateDelegationRequestCommand_base: {
    new (input: CreateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<CreateDelegationRequestCommandInput, CreateDelegationRequestCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<CreateDelegationRequestCommandInput, CreateDelegationRequestCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
