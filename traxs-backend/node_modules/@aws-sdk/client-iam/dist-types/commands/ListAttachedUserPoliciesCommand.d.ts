...
import type { ListAttachedUserPoliciesRequest, ListAttachedUserPoliciesResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAttachedUserPoliciesCommand_base: {
    new (input: ListAttachedUserPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedUserPoliciesCommandInput, ListAttachedUserPoliciesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAttachedUserPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedUserPoliciesCommandInput, ListAttachedUserPoliciesCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
