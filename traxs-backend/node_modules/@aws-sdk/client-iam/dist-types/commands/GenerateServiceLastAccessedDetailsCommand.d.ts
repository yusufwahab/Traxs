...
import type { GenerateServiceLastAccessedDetailsRequest, GenerateServiceLastAccessedDetailsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GenerateServiceLastAccessedDetailsCommand_base: {
    new (input: GenerateServiceLastAccessedDetailsCommandInput): import("@smithy/core/client").CommandImpl<GenerateServiceLastAccessedDetailsCommandInput, GenerateServiceLastAccessedDetailsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GenerateServiceLastAccessedDetailsCommandInput): import("@smithy/core/client").CommandImpl<GenerateServiceLastAccessedDetailsCommandInput, GenerateServiceLastAccessedDetailsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
