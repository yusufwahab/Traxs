...
import type { GenerateOrganizationsAccessReportRequest, GenerateOrganizationsAccessReportResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GenerateOrganizationsAccessReportCommand_base: {
    new (input: GenerateOrganizationsAccessReportCommandInput): import("@smithy/core/client").CommandImpl<GenerateOrganizationsAccessReportCommandInput, GenerateOrganizationsAccessReportCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GenerateOrganizationsAccessReportCommandInput): import("@smithy/core/client").CommandImpl<GenerateOrganizationsAccessReportCommandInput, GenerateOrganizationsAccessReportCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
