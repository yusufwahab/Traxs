...
import type { DeleteUserPermissionsBoundaryRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteUserPermissionsBoundaryCommand_base: {
    new (input: DeleteUserPermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPermissionsBoundaryCommandInput, DeleteUserPermissionsBoundaryCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteUserPermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPermissionsBoundaryCommandInput, DeleteUserPermissionsBoundaryCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
