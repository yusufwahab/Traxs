...
import type { GetGroupPolicyRequest, GetGroupPolicyResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetGroupPolicyCommand_base: {
    new (input: GetGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetGroupPolicyCommandInput, GetGroupPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetGroupPolicyCommandInput, GetGroupPolicyCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
