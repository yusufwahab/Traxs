...
import type { TagServerCertificateRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const TagServerCertificateCommand_base: {
    new (input: TagServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<TagServerCertificateCommandInput, TagServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: TagServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<TagServerCertificateCommandInput, TagServerCertificateCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
