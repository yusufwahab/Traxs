...
import type { EnableMFADeviceRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const EnableMFADeviceCommand_base: {
    new (input: EnableMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<EnableMFADeviceCommandInput, EnableMFADeviceCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<EnableMFADeviceCommandInput, EnableMFADeviceCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
