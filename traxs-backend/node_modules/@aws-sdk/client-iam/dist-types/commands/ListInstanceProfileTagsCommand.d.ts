...
import type { ListInstanceProfileTagsRequest, ListInstanceProfileTagsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListInstanceProfileTagsCommand_base: {
    new (input: ListInstanceProfileTagsCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfileTagsCommandInput, ListInstanceProfileTagsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListInstanceProfileTagsCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfileTagsCommandInput, ListInstanceProfileTagsCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
