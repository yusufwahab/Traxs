...
import type { UntagUserRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UntagUserCommand_base: {
    new (input: UntagUserCommandInput): import("@smithy/core/client").CommandImpl<UntagUserCommandInput, UntagUserCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UntagUserCommandInput): import("@smithy/core/client").CommandImpl<UntagUserCommandInput, UntagUserCommandOutput, IAMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
