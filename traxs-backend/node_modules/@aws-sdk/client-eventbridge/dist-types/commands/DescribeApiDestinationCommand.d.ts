...
import type { DescribeApiDestinationRequest, DescribeApiDestinationResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeApiDestinationCommand_base: {
    new (input: DescribeApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<DescribeApiDestinationCommandInput, DescribeApiDestinationCommandOutput, EventBridgeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<DescribeApiDestinationCommandInput, DescribeApiDestinationCommandOutput, EventBridgeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
